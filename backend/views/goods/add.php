                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-stripped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="goods_images" disabled
                                                   value="http://mydomain.com/images/image1.png">
                                        </td>
                                        <td><input type="text" class="form-control" id="goods_images_sort"
                                                   value="222"></td>
                                        <td>
                                ...
                                <?= $form->field($Goods, 'goods_img')->hiddenInput(['id' => 'goods_img'])->label(''); ?>
                            </div>
