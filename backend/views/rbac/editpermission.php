                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal">
                        <div class="form-group <?php if(isset($error['description'])):?>has-error<?php endif;?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="PermissionForm[description]" value="<?=$AuthObj->description;?>" placeholder="权限名称" class="form-control">
                            </div>
                        ...
                        <div class="form-group <?php if(isset($error['name'])):?>has-error<?php endif;?>"><label class="col-sm-2 control-label">权限路径</label>
                            <div class="col-sm-8">
                                <input type="text" name="PermissionForm[name]" value="<?=$AuthObj->name;?>" placeholder="权限路径"  class="form-control">
                            </div>
