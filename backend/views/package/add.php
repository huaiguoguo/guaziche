                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <fieldset class="form-horizontal">
                                        ...
                                        echo $form->field($Package, 'package_name')
                                            ->textInput(['placeholder' => '套餐名称'])
                                            ->label('套餐名称');

                                        echo $form->field($Package, 'package_price')
                                            ->textInput(['placeholder' => '0.00'])
                                            ->label('套餐价格');


                                        echo $form->field($Package, 'package_desc')
                                            ->textarea(['placeholder' => '套餐介绍',])
                                            ->label('套餐介绍');


//                                        echo $form->field($Package, 'goods_ids')
//                                            ->checkboxList(['足球', '篮球', '地球'], ['class'=>'i-checks'])
//                                            ->label('商品');
                                        ?>
                                        <div class="form-group field-packages-goods_id required">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div id="packages-goods_id" class="i-checks"> </div>
                                            </div>
