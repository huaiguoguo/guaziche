/**
 * Created by huochai on 2016/7/17.
 */
    ...
    var PHPHub = {
        ...
        initLocalStorage: function() {
            ...
            $("#topic-create-form").submit(function(event){
                ...
                $("#topic-create-submit").val('æäº¤ä¸­...').addClass('disabled').prop('disabled', true);
        ...
        initDataAjax: function() {
            ...
            $(document).on('click', '[data-ajax]', function() {
                ...
                var csrf_param = that.data('csrf_param');
                var csrf_token = that.data('csrf_token');
        ...
        showPluginDownload: function() {
            this.showMsg('æ“ä½œæˆåŠŸï¼Œå®‰è£… <a target="_blank" href="https://chrome.google.com/webstore/detail/fcopfkdgikhodlcjkjdppdfkbhmehdon">Chrome æ’ä»¶</a> æŽ¥æ”¶æé†’ã€‚', {
                type: 'success',
                timer: 8000
            });
        },
